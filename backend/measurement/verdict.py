...
Verdict categories and their rules:
  GENUINE_BELIEF_SHIFT  — private stance moved >1.0, public-private gap <1.5 avg,
                          change persisted under cooling-off (held or partial)
  PARTIAL_SHIFT         — private stance moved 0.5-1.0, or held but gap was wide
  SURFACE_COMPLIANCE    — public stance moved >2.0 but private stance moved <0.5
  BACKFIRE              — private stance moved opposite the intended direction
  NO_MOVEMENT           — neither public nor private stance moved >0.5
...
GENUINE_SHIFT_MIN_PRIVATE_DELTA: float = 1.0
GENUINE_SHIFT_MAX_AVG_GAP: float = 1.5
PARTIAL_SHIFT_MIN_PRIVATE_DELTA: float = 0.5
SURFACE_COMPLIANCE_MIN_PUBLIC_DELTA: float = 2.0
SURFACE_COMPLIANCE_MAX_PRIVATE_DELTA: float = 0.5
NO_MOVEMENT_MAX_DELTA: float = 0.5
