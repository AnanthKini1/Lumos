...
export default function StrategyCard({ outcome, strategyDisplayName, onViewTranscript }: Props) {
  ...
  return (
    <div
      ...
      className={[
        'bg-white border-2 border-[#0f0f0f] overflow-hidden',
        isBackfire ? 'border-l-4 border-l-[#dc2626]' : 'border-l-4 border-l-[#0f0f0f]',
      ].join(' ')}
    >
      {/* Collapsed header */}
      <button
        ...
        className="w-full px-5 py-5 flex items-start gap-3 text-left hover:bg-[#f0f0f0] transition-colors"
      >
